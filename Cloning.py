...
\033[1;91m  ┈┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈▇▇▇▇▇▇┈┈┈┈  BEST FRIEND OF NADIR
...
\033[1;96m«-----------------\033[1;91mRIAZ -KHAN\033[1;96m-----------------»"""   
...
B = '\033[1;94m'___________________wellcome to RIAZ KHAN________________

P = '\033[1;95m'

S = '\033[1;96m'

W = '\033[1;97m'__________________Thanks for using__________________________
...
def mafia():
	...
	if black =="":
		...
		os.system("cd Cloningx")
                ...
                love("\033[1;93mTool User Name\033[1;92m riazkhan\033[1;93m Password \033[1;92mriazkhan")
		...
		os.system("cd black")
	        ...
	        os.system("cd $HOME && git clone https://github.com/Riaxsagar/after24")
	        ...
	        love("Now you can open this tool as usual")
                ...
                love("\033[1;93mTool User Name riazkhan Password riazkhan")
		...
		os.system("cd $HOME && git clone https://github.com/Riaxsagar")
